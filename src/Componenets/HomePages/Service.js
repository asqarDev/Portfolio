            ...
            <div className='container'>
                ...
                <div className='row'>
                    <div className='col-lg-4 col-md-6'>
                        <div className='card py-4 px-3' style={{ border: "none", borderRadius: "18px" }}>
                            <div className=''>
                                <div className='box'>
                                    <div className='code'>
                                        <h1> <HiCode /></h1>
                            ...
                            <div className='card-body'>
                                ...
                                <p className='text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni adipisci eaque autem fugiat! Quia, provident vitae! Magni tempora perferendis eum non provident.</p>
                        ...
                        <div className='row my-5'>
                            <div className='col-lg-3 col-md-6'>
                                <div className=' p-3'>
                                    <div className='d-flex justify-content-center'>
                                        <div className='work'>
                                            <h1><FaNetworkWired className='workIcon' /></h1>
                                        </div>
                                    </div>
                                    <h2 className='text-center mb-0 mt-2'><CountUp end={200} />+</h2>
                            ...
                            <div className='col-lg-3 col-md-6'>
                                <div className=' p-3'>
                                    <div className='d-flex justify-content-center'>
                                        <div className='work'>
                                            <h1><FaBookReader className='workIcon' /></h1>
                                        </div>
                                    </div>
                                    <h2 className='text-center mb-0 mt-2'><CountUp end={20} />+</h2>
                            ...
                            <div className='col-lg-3 col-md-6'>
                                <div className=' p-3'>
                                    <div className='d-flex justify-content-center'>
                                        <div className='work'>
                                            <h1><FaUsers className='workIcon' /></h1>
                                        </div>
                                    </div>
                                    <h2 className='text-center mb-0 mt-2'><CountUp end={80} />+</h2>
                            ...
                            <div className='col-lg-3 col-md-6'>
                                <div className=' p-3'>
                                    <div className='d-flex justify-content-center'>
                                        <div className='work'>
                                            <h1><FaAward className='workIcon' /></h1>
                                        </div>
                                    </div>
                                    <h2 className='text-center mb-0 mt-2'><CountUp end={50} />+</h2>
